...
import { actionCategory, colors, dramaCategory, dramaCH7, highLight, iconLists, imageCategory, lastNews, movieAndSeries, newContent, originalCategory, originalNewContent, popularTag, popularTag2, shortSeriesCategory, sportCategory, techCategory, topTenToday } from '@/constants/utils';
import { LinearGradient } from 'expo-linear-gradient';
import { StatusBar } from 'expo-status-bar';
import { useVideoPlayer, VideoView } from 'expo-video';
import { ArrowRight, ChevronLeft, ChevronRight, Crown, Menu, MoveRight, Store } from 'lucide-react-native';
import { Dimensions, FlatList, Image, ImageBackground, Linking, Pressable, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native';
        ...
        <ImageBackground
            ...
            <View style={styles.navBar}>
                ...
                <ScrollView
                    ...
                    <View style={styles.newContentContainer}>
                        <NameSection title={'ข่าวล่าสุด'} linkColor={colors.darkPurple2} link={'https://www.bugaboo.tv/th/news/all/'} />
                    ...
                    <View style={styles.newContentContainer}>
                        <NameSection title={'เทคโนโลยี'} linkColor={colors.darkPurple2} link={'https://www.bugaboo.tv/th/variety/how-to-tricks/'} />
                        <BannerHorizontal data={techCategory} />
                    </View>
